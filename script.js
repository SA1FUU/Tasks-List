...
let inputBtnContainer = document.querySelector(".input-btn-container")
...
function CreateNotification(popup) {
    let div = document.createElement("div")
    div.classList.add("alert-popup-box")
    ...
    h3.classList.add("alert-popup")

    div.appendChild(i)
    div.appendChild(h3)

    h3.textContent = popup
}
...
function addTask() {
    if (inputValue.value === "") {
        CreateNotification(popup = "ENter Task")
...
function addProfileDiv() {
    ...
    inputBtnContainer.style.pointerEvents = "none"
}
...
closeProfileButton.addEventListener("click", () => {
    ...
    inputBtnContainer.style.pointerEvents = "all"
})
...
function saveProfileData() {
    localStorage.setItem("task-list-profile", userInfo.innerText)
}

function showProfileData() {
    userInfo.innerText = localStorage.getItem("task-list-profile")
}
showProfileData()
